...
{
    public class LinkSuncorCard:LoyaltyAction
    {
        public LinkSuncorCard(string loyaltyCardNumber, int productId, string linkedCardNumber, string bonusType, string cardType) : base(loyaltyCardNumber, productId, linkedCardNumber, bonusType, cardType)
        {
        ...
        //        var cardDetails = cardsManagerData.CheckIfBPCardExists(LinkedCardNumber);
        ...
        public override bool UpdateBonusGivenDate()
        {
            ...
            {
                var cardsManagerData = new ManageCardsData(conn);
                int updateBonusDate = cardsManagerData.UpdateBPCBonusdate(LinkedCardNumber);
